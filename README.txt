...
4) Close the program by pressing Enter once it's finished. Double click on the "Output" folder and you should see a filme called [your-list].txt open this, and you'll find a long list of all the email addresses on the list you requested. 
